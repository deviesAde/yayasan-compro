            ...
            >
              ...
              <div className="flex flex-col gap-6">
                <span className="text-[10px] font-mono uppercase tracking-widest text-foreground/30 font-bold text-left flex items-center gap-2">
                  <span className="w-6 h-[1px] bg-border-color" /> 01. Select Amount
                </span>
                    ...
                    <button
                      ...
                      className={`h-14 rounded-2xl text-[13px] font-bold uppercase tracking-wider transition-all duration-300 flex items-center justify-center border ${
                        formData.amount === preset.value && !formData.customAmount
                          ? "bg-foreground text-cream border-foreground shadow-lg shadow-foreground/20"
                          : "bg-foreground/[0.02] text-foreground/60 border-border-color hover:bg-foreground/[0.05] hover:border-foreground/10"
                      }`}
                    >
                      {preset.label}
                    </button>
                ...
                <div className="flex flex-col gap-3 text-left">
                  <label htmlFor="customAmount" className="text-[11px] font-bold uppercase tracking-widest text-foreground/40 ml-2">
                    Or Enter Custom Amount (Rp)
                  </label>
                  <div className="relative group">
                    <span className="absolute left-6 top-1/2 transform -translate-y-1/2 text-sm font-bold text-foreground/30">
                      Rp
                    </span>
                    <input
                      type="number"
                      ...
                      className="w-full h-14 pl-14 pr-6 rounded-2xl border border-border-color text-sm bg-background font-bold text-foreground placeholder:text-foreground/20 focus:outline-none focus:border-terracotta focus:ring-4 focus:ring-terracotta/5 transition-all duration-300 shadow-sm group-hover:border-foreground/20"
                    />
                  </div>
                  <span className="text-[9px] text-foreground/30 font-mono tracking-wider ml-2 font-bold">
              ...
              <div className="flex flex-col gap-6">
                <span className="text-[10px] font-mono uppercase tracking-widest text-foreground/30 font-bold text-left flex items-center gap-2">
                   <span className="w-6 h-[1px] bg-border-color" /> 02. Transfer Method
                </span>
              ...
              <div className="flex flex-col gap-6">
                <span className="text-[10px] font-mono uppercase tracking-widest text-foreground/30 font-bold text-left flex items-center gap-2">
                   <span className="w-6 h-[1px] bg-border-color" /> 03. Donor Particulars
                </span>
              ...
              <div className="flex flex-col gap-6">
                <span className="text-[10px] font-mono uppercase tracking-widest text-foreground/30 font-bold text-left flex items-center gap-2">
                   <span className="w-6 h-[1px] bg-border-color" /> 04. Proof of Transfer
                </span>
